...
final class DequeSliceTests: XCTestCase {
    ...
    func testInitRepeatingCount() {
        sut = DequeSlice(repeating: 10, count: 0)
        XCTAssertNotNil(sut)
        XCTAssertTrue(sut.isEmpty)
        
        sut = DequeSlice(repeating: 10, count: 10)
        XCTAssertNotNil(sut)
